...
const translations = {
    'zh-CN': {
        ...
        'oauth.kiro.idc': '企业 (IAM Identity Center SSO)',
        'oauth.kiro.idcDesc': '通过 IAM Identity Center 的 Start URL 进行设备码授权',
        'oauth.kiro.idcTitle': 'IAM Identity Center (SSO)',
        'oauth.kiro.idcHint': '请输入企业 IAM Identity Center 的 Start URL 与区域（Region）',
        'oauth.kiro.idcStartUrlRequired': 'Start URL 不能为空',
        'oauth.kiro.idcStartUrlInvalid': 'Start URL 无效，请检查格式',
        ...
        'oauth.kiro.awsNodeConfigTitle': '节点配置 (推荐)',
        'oauth.kiro.awsNodeConfigEnabled': '创建并绑定到节点',
        'oauth.kiro.awsNodeConfigHint': '推荐：创建一个节点并绑定凭据，这样可以一次性设置 accountId / machineId / 代理 / BitBrowser Profile。',
        'oauth.kiro.awsBitbrowserTitle': '隔离浏览器 (BitBrowser)',
        'oauth.kiro.awsBitbrowserEnabled': '绑定 BitBrowser Profile',
        'oauth.kiro.awsBitbrowserHint': '可选。启用后会为该节点创建/绑定 BitBrowser Profile，并使用该节点的代理配置。',
        ...
        'config.bitbrowser.title': '隔离浏览器 (BitBrowser)',
        'config.bitbrowser.enabled': '启用 BitBrowser',
        'config.bitbrowser.apiUrl': 'API 地址',
        'config.bitbrowser.apiUrlPlaceholder': '例如: http://127.0.0.1:54345',
        'config.bitbrowser.apiUrlNote': 'BitBrowser 本地服务地址，必须可从 AIClient 主机访问',
        'config.bitbrowser.coreVersion': '内核版本',
        'config.bitbrowser.coreVersionPlaceholder': '例如: 124',
        'config.bitbrowser.coreVersionNote': '部分系统不支持过高内核版本，请按 BitBrowser 文档设置',
        'config.isolated.provider': '隔离浏览器提供商',
        'config.isolated.provider.bitbrowser': 'BitBrowser',
        'config.isolated.provider.localChromium': '本地 Chromium (Linux/Xpra/noVNC/Kasm)',
        'config.isolated.localEnabled': '启用本地 Chromium',
        'config.isolated.localOpenCommand': '本地浏览器启动命令模板（可选）',
        'config.isolated.localOpenCommandPlaceholder': '例如: xpra start :100 --bind-tcp=0.0.0.0:14500 --html=on --start-child=\"chromium --user-data-dir={profileDir_raw} {url_raw}\"',
        'config.isolated.localOpenCommandNote': '支持占位符 {url}/{profileDir}/{proxyUrl}/{providerType}/{uuid}，以及 *_raw 版本。可用于 Xpra/noVNC/Kasm 启动链路。',
        'config.isolated.localProfileBaseDir': '本地浏览器 Profile 目录',
        'config.isolated.localProfileBaseDirPlaceholder': '例如: configs/browser-profiles',
        'config.isolated.localProfileBaseDirNote': '每个节点会分配独立 user-data-dir',
        ...
        'modal.provider.risk.infoBtn': '释放信息',
        'modal.provider.risk.releaseBtn': '手动释放',
        'modal.provider.risk.opsBtn': '风险运维',
        'modal.provider.risk.infoTitle': '凭证释放信息',
        'modal.provider.risk.infoLoaded': '已加载释放信息',
        'modal.provider.risk.info.credential': '凭证',
        'modal.provider.risk.info.state': '当前状态',
        'modal.provider.risk.info.canRelease': '可手动释放',
        'modal.provider.risk.info.requiresForce': '需要强制参数',
        'modal.provider.risk.info.cooldownUntil': '冷却截止',
        'modal.provider.risk.info.requiredFields': '必填字段',
        'modal.provider.risk.info.allowedTargets': '允许目标状态',
        'modal.provider.risk.error.fetchInfo': '获取释放信息失败',
        'modal.provider.risk.error.contextMissing': '无法识别当前提供商上下文',
        'modal.provider.risk.releaseBlocked': '当前状态不可手动释放',
        'modal.provider.risk.release.targetPrompt': '请输入目标状态（可选: {allowed}）',
        'modal.provider.risk.release.invalidTarget': '目标状态无效，允许值: {allowed}',
        'modal.provider.risk.release.reasonPrompt': '请输入释放原因（至少8个字符）',
        'modal.provider.risk.release.reasonTooShort': '释放原因至少需要8个字符',
        'modal.provider.risk.release.confirmCredentialPrompt': '请输入凭证ID以确认释放: {credentialId}',
        'modal.provider.risk.release.confirmCredentialMismatch': '凭证ID不匹配，已取消释放',
        'modal.provider.risk.release.forceConfirm': '该凭证状态为 {state}，需要强制释放。确认继续吗？',
        'modal.provider.risk.release.finalConfirm': '请确认执行手动释放：\n凭证: {credentialId}\n目标状态: {targetState}\nforce: {force}',
        'modal.provider.risk.release.success': '手动释放成功：{credentialId} -> {targetState}',
        'modal.provider.risk.release.failed': '手动释放失败',
        'modal.provider.risk.badge.loading': '风险状态加载中...',
        'modal.provider.risk.badge.unavailable': '状态不可用',
        'modal.provider.risk.badge.blocked': '已阻断',
        'modal.provider.risk.badge.ready': '可路由',
        'modal.provider.risk.badge.cooldownUntil': '冷却截止',
        'modal.provider.proxy.badge.loading': '代理状态加载中...',
        'modal.provider.proxy.badge.unavailable': '代理状态不可用',
        'modal.provider.proxy.badge.off': '直连',
        'modal.provider.proxy.badge.on': '代理',
        'modal.provider.proxy.badge.misconfigured': '代理缺失',
        'modal.provider.proxy.badge.shared': '代理共享',
        'modal.provider.proxy.hint.source.node': '节点',
        'modal.provider.proxy.hint.source.global': '全局',
        'modal.provider.proxy.hint.disabledProvider': '未在「配置-代理设置」中启用该提供商',
        'modal.provider.proxy.testBtn': '代理自检',
        'modal.provider.proxy.testRunning': '正在测试代理...',
        'modal.provider.proxy.testOk': '代理测试成功',
        'modal.provider.proxy.testFailed': '代理测试失败',
        'modal.provider.proxy.enabled': '代理',
        'modal.provider.proxy.disabled': '已禁用代理',
        'modal.provider.proxy.none': '未配置代理',
        'modal.provider.bitbrowser.badge.none': '未绑定浏览器配置',
        'modal.provider.bitbrowser.badge.on': '隔离浏览器',
        'modal.provider.bitbrowser.openBtn': '打开隔离浏览器',
        'modal.provider.bitbrowser.oauthBtn': '隔离浏览器 OAuth',
        'modal.provider.bitbrowser.opening': '正在打开隔离浏览器...',
        'modal.provider.bitbrowser.opened': '隔离浏览器已打开 (Profile: {id})',
        'modal.provider.bitbrowser.openFailed': '打开隔离浏览器失败',
        'modal.provider.bitbrowser.unsupported': '当前提供商不支持隔离浏览器',
        'modal.provider.bitbrowser.oauthFailed': '启动隔离 OAuth 失败',
        'modal.provider.kiro.inspectBtn': '账号详情',
        'modal.provider.kiro.inspectTitle': 'Kiro 账号详情',
        'modal.provider.kiro.inspectLoading': '正在获取账号详情...',
        'modal.provider.kiro.inspectFailed': '获取账号详情失败',
        'modal.provider.kiroWizard.btn': '企业账号向导',
        'modal.provider.kiroWizard.title': '添加企业 Kiro 账号',
        'modal.provider.kiroWizard.accountId': '账号 ID',
        'modal.provider.kiroWizard.accountIdHint': '系统会自动生成，可随时修改用于标识该账号',
        'modal.provider.kiroWizard.machineId': '机器 ID',
        'modal.provider.kiroWizard.machineIdHint': '可选。留空则自动生成。仅允许 8-128 字符，字符集 [A-Za-z0-9._:-]。',
        'modal.provider.kiroWizard.proxyTitle': '代理 (推荐每账号一个)',
        'modal.provider.kiroWizard.proxyEnabled': '启用代理',
        'modal.provider.kiroWizard.proxyUrl': '代理 URL',
        'modal.provider.kiroWizard.proxyUrlHint': '支持 socks5://、http://、https:// (示例: socks5://user:pass@host:port)',
        'modal.provider.kiroWizard.bitbrowserTitle': '隔离浏览器 (BitBrowser)',
        'modal.provider.kiroWizard.useBitbrowser': '使用隔离浏览器登录',
        'modal.provider.kiroWizard.bitbrowserEnabled': '启用 BitBrowser',
        'modal.provider.kiroWizard.bitbrowserApiUrl': 'BitBrowser API URL',
        'modal.provider.kiroWizard.bitbrowserCoreVersion': '内核版本',
        'modal.provider.kiroWizard.bitbrowserHint': 'BitBrowser 窗口会在运行 BitBrowser 的机器上打开；远程访问请使用 RDP/SSH GUI。',
        'modal.provider.kiroWizard.wslHint': '如果 AIClient 运行在 WSL 而 BitBrowser 运行在 Windows，API URL 常见为 http://172.17.16.1:54345',
        'modal.provider.kiroWizard.idcTitle': 'IAM Identity Center (SSO)',
        'modal.provider.kiroWizard.startUrl': 'Start URL',
        'modal.provider.kiroWizard.region': 'AWS Region',
        'modal.provider.kiroWizard.createAndLogin': '创建并登录',
        'modal.provider.kiroWizard.creating': '正在创建账号并启动企业登录...',
        'modal.provider.risk.state.healthy': '健康',
        'modal.provider.risk.state.needs_refresh': '待刷新',
        'modal.provider.risk.state.cooldown': '冷却中',
        'modal.provider.risk.state.quarantined': '隔离中',
        'modal.provider.risk.state.suspended': '已暂停',
        'modal.provider.risk.state.banned': '已封禁',
        'modal.provider.risk.state.disabled': '已禁用',
        'modal.provider.risk.state.unknown': '未知',
        'modal.provider.risk.modal.titleInfo': '凭证释放信息',
        'modal.provider.risk.modal.titleRelease': '手动释放凭证',
        'modal.provider.risk.form.targetState': '目标状态',
        'modal.provider.risk.form.operator': '操作人',
        'modal.provider.risk.form.reason': '释放原因',
        'modal.provider.risk.form.reasonPlaceholder': '请填写释放原因（至少8个字符）',
        'modal.provider.risk.form.confirmCredentialId': '确认凭证ID',
        'modal.provider.risk.form.releaseTicketId': 'Release Ticket',
        'modal.provider.risk.form.force': '强制释放',
        'modal.provider.risk.form.forceRequiredHint': '当前状态要求 force=true 才能释放',
        'modal.provider.risk.form.ack': '我已核对凭证ID与释放原因，并确认执行此操作',
        'modal.provider.risk.form.submit': '执行释放',
        'modal.provider.risk.form.submitting': '正在提交释放请求...',
        'modal.provider.risk.validation.cannotRelease': '当前状态不允许手动释放',
        'modal.provider.risk.validation.targetRequired': '请选择有效的目标状态',
        'modal.provider.risk.validation.reasonTooShort': '释放原因至少需要8个字符',
        'modal.provider.risk.validation.confirmMismatch': '凭证ID不匹配，请重新确认',
        'modal.provider.risk.validation.ackRequired': '请勾选确认项后再提交',
        'modal.provider.risk.ops.title': '风险控制动作',
        'modal.provider.risk.ops.policyMode': '策略模式',
        'modal.provider.risk.ops.policyEnabled': '策略启用',
        'modal.provider.risk.ops.policyEnabledSet': '设置策略启用',
        'modal.provider.risk.ops.policyModeSet': '设置策略模式',
        'modal.provider.risk.ops.collisionWindowMs': '身份碰撞窗口（毫秒）',
        'modal.provider.risk.ops.drainMode': 'Drain 状态',
        'modal.provider.risk.ops.drainOn': '开启 Drain',
        'modal.provider.risk.ops.drainOff': '关闭 Drain',
        'modal.provider.risk.ops.cooldownMinutes': '冷却时长（分钟）',
        'modal.provider.risk.ops.reason': '操作原因',
        'modal.provider.risk.ops.reasonPlaceholder': '请填写操作原因（用于审计）',
        'modal.provider.risk.ops.updatePolicy': '更新策略',
        'modal.provider.risk.ops.policyUpdated': '策略更新成功',
        'modal.provider.risk.ops.applyDrain': '应用 Drain',
        'modal.provider.risk.ops.applyCooldown': '应用冷却',
        'modal.provider.risk.ops.clearCooldown': '清除冷却',
        'modal.provider.risk.ops.forceRefresh': '强制刷新',
        'modal.provider.risk.ops.refreshPreview': '刷新选点预览',
        'modal.provider.risk.ops.executing': '正在执行操作...',
        'modal.provider.risk.ops.actionSuccess': '操作成功：{action}',
        'modal.provider.risk.ops.actionFailed': '操作失败',
        'modal.provider.risk.ops.fetchFailed': '加载风险运维信息失败',
        'modal.provider.risk.ops.invalidCooldown': '请输入有效的冷却分钟数',
        'modal.provider.risk.ops.invalidCollisionWindow': '请输入有效的身份碰撞窗口（毫秒）',
        'modal.provider.risk.policy.fetchFailed': '获取风险策略配置失败',
        'modal.provider.risk.preview.fetchFailed': '获取选点预览失败',
        'modal.provider.risk.preview.loading': '正在加载选点预览...',
        'modal.provider.risk.preview.empty': '暂无选点预览数据',
        'modal.provider.risk.preview.noneSelected': '无可选节点',
        'modal.provider.risk.preview.selected': '当前选中',
        'modal.provider.risk.preview.total': '总节点数',
        'modal.provider.risk.preview.candidates': '候选节点数',
        'modal.provider.risk.preview.blocked': '策略阻断数',
        'modal.provider.risk.preview.topCandidates': '候选列表',
        'modal.provider.risk.preview.priority': '优先级',
        'modal.provider.risk.preview.score': '评分',
        'modal.provider.risk.preview.nextAvailableAt': '下一次可用时间',
        'modal.provider.risk.preview.excluded': '排除统计',
        'modal.provider.risk.preview.excluded.disabled': '已禁用',
        'modal.provider.risk.preview.excluded.unhealthy': '不健康',
        'modal.provider.risk.preview.excluded.needsRefresh': '需要刷新',
        'modal.provider.risk.preview.excluded.draining': '排空中',
        'modal.provider.risk.preview.excluded.coolingDown': '冷却中',
        'modal.provider.risk.preview.excluded.blockedByRiskPolicy': '被策略阻断',
        'modal.provider.risk.preview.excluded.modelNotSupported': '模型不支持',
        ...
        'modal.provider.field.machineId': '机器ID',
        'modal.provider.field.machineId.placeholder': '例如: a1b2c3d4e5f6...',
        'modal.provider.field.proxyUrl': '代理地址 (节点)',
        'modal.provider.field.proxyUrl.placeholder': '例如: http://127.0.0.1:7890 或 socks5://127.0.0.1:1080',
        'modal.provider.field.bitbrowserProfileId': 'BitBrowser Profile ID',
        'modal.provider.field.bitbrowserProfileId.placeholder': '例如: 93672cf112a044f08b653cab691216f0',
        'modal.provider.field.accountId': '账户ID',
        'modal.provider.field.accountId.placeholder': '例如: kiro-account-01',
        'modal.provider.field.authMethod': '认证方式',
        'modal.provider.field.authMethod.placeholder': 'social 或 builder-id',
        'modal.provider.field.profileArn': 'Profile ARN',
        'modal.provider.field.profileArn.placeholder': '例如: arn:aws:iam::123456789012:user/demo',
        'modal.provider.field.refreshToken': 'Refresh Token',
        'modal.provider.field.refreshToken.placeholder': '可选：覆盖凭证文件中的 refreshToken',
        'modal.provider.field.clientId': 'Client ID',
        'modal.provider.field.clientId.placeholder': '可选：IDC 刷新所需 clientId',
        'modal.provider.field.clientSecret': 'Client Secret',
        'modal.provider.field.clientSecret.placeholder': '可选：IDC 刷新所需 clientSecret',
    ...
    'en-US': {
        ...
        'oauth.kiro.idc': 'IAM Identity Center (SSO)',
        'oauth.kiro.idcDesc': 'Device code auth via your IAM Identity Center Start URL',
        'oauth.kiro.idcTitle': 'IAM Identity Center (SSO)',
        'oauth.kiro.idcHint': 'Enter your IAM Identity Center Start URL and AWS Region',
        'oauth.kiro.idcStartUrlRequired': 'Start URL is required',
        'oauth.kiro.idcStartUrlInvalid': 'Invalid Start URL',
        ...
        'oauth.kiro.awsNodeConfigTitle': 'Provider Node (Recommended)',
        'oauth.kiro.awsNodeConfigEnabled': 'Create and attach',
        'oauth.kiro.awsNodeConfigHint': 'Recommended: create a node and attach the credential so you can set accountId / machineId / proxy / BitBrowser profile in one place.',
        'oauth.kiro.awsBitbrowserTitle': 'Isolated Browser (BitBrowser)',
        'oauth.kiro.awsBitbrowserEnabled': 'Bind BitBrowser Profile',
        'oauth.kiro.awsBitbrowserHint': 'Optional. When enabled, a BitBrowser profile will be created/bound for this node and will use the node proxy.',
        ...
        'config.bitbrowser.title': 'Isolated Browser (BitBrowser)',
        'config.bitbrowser.enabled': 'Enable BitBrowser',
        'config.bitbrowser.apiUrl': 'API URL',
        'config.bitbrowser.apiUrlPlaceholder': 'e.g. http://127.0.0.1:54345',
        'config.bitbrowser.apiUrlNote': 'BitBrowser local service address. Must be reachable from the AIClient host',
        'config.bitbrowser.coreVersion': 'Core Version',
        'config.bitbrowser.coreVersionPlaceholder': 'e.g. 124',
        'config.bitbrowser.coreVersionNote': 'Some systems do not support high core versions. Follow BitBrowser documentation',
        'config.isolated.provider': 'Isolated Browser Provider',
        'config.isolated.provider.bitbrowser': 'BitBrowser',
        'config.isolated.provider.localChromium': 'Local Chromium (Linux/Xpra/noVNC/Kasm)',
        'config.isolated.localEnabled': 'Enable Local Chromium',
        'config.isolated.localOpenCommand': 'Local browser launch command template (optional)',
        'config.isolated.localOpenCommandPlaceholder': 'e.g. xpra start :100 --bind-tcp=0.0.0.0:14500 --html=on --start-child=\"chromium --user-data-dir={profileDir_raw} {url_raw}\"',
        'config.isolated.localOpenCommandNote': 'Supports placeholders {url}/{profileDir}/{proxyUrl}/{providerType}/{uuid} and *_raw variants. Useful for Xpra/noVNC/Kasm workflows.',
        'config.isolated.localProfileBaseDir': 'Local browser profile base dir',
        'config.isolated.localProfileBaseDirPlaceholder': 'e.g. configs/browser-profiles',
        'config.isolated.localProfileBaseDirNote': 'Each provider node gets its own user-data-dir',
        ...
        'modal.provider.risk.infoBtn': 'Release Info',
        'modal.provider.risk.releaseBtn': 'Manual Release',
        'modal.provider.risk.opsBtn': 'Risk Ops',
        'modal.provider.risk.infoTitle': 'Credential Release Info',
        'modal.provider.risk.infoLoaded': 'Release info loaded',
        'modal.provider.risk.info.credential': 'Credential',
        'modal.provider.risk.info.state': 'Current State',
        'modal.provider.risk.info.canRelease': 'Can Manual Release',
        'modal.provider.risk.info.requiresForce': 'Requires Force',
        'modal.provider.risk.info.cooldownUntil': 'Cooldown Until',
        'modal.provider.risk.info.requiredFields': 'Required Fields',
        'modal.provider.risk.info.allowedTargets': 'Allowed Target States',
        'modal.provider.risk.error.fetchInfo': 'Failed to fetch release info',
        'modal.provider.risk.error.contextMissing': 'Unable to resolve provider context',
        'modal.provider.risk.releaseBlocked': 'Current state is not eligible for manual release',
        'modal.provider.risk.release.targetPrompt': 'Enter target state (allowed: {allowed})',
        'modal.provider.risk.release.invalidTarget': 'Invalid target state. Allowed values: {allowed}',
        'modal.provider.risk.release.reasonPrompt': 'Enter release reason (at least 8 characters)',
        'modal.provider.risk.release.reasonTooShort': 'Release reason must be at least 8 characters',
        'modal.provider.risk.release.confirmCredentialPrompt': 'Type credential ID to confirm release: {credentialId}',
        'modal.provider.risk.release.confirmCredentialMismatch': 'Credential ID mismatch, release cancelled',
        'modal.provider.risk.release.forceConfirm': 'Credential state is {state}, force=true is required. Continue?',
        'modal.provider.risk.release.finalConfirm': 'Confirm manual release:\nCredential: {credentialId}\nTarget state: {targetState}\nforce: {force}',
        'modal.provider.risk.release.success': 'Manual release succeeded: {credentialId} -> {targetState}',
        'modal.provider.risk.release.failed': 'Manual release failed',
        'modal.provider.risk.badge.loading': 'Loading risk state...',
        'modal.provider.risk.badge.unavailable': 'Unavailable',
        'modal.provider.risk.badge.blocked': 'Blocked',
        'modal.provider.risk.badge.ready': 'Admitted',
        'modal.provider.risk.badge.cooldownUntil': 'Cooldown Until',
        'modal.provider.proxy.badge.loading': 'Loading proxy state...',
        'modal.provider.proxy.badge.unavailable': 'Proxy unavailable',
        'modal.provider.proxy.badge.off': 'Direct',
        'modal.provider.proxy.badge.on': 'Proxy',
        'modal.provider.proxy.badge.misconfigured': 'Missing Proxy URL',
        'modal.provider.proxy.badge.shared': 'Shared Proxy',
        'modal.provider.proxy.hint.source.node': 'Node',
        'modal.provider.proxy.hint.source.global': 'Global',
        'modal.provider.proxy.hint.disabledProvider': 'Provider is not enabled in Config > Proxy Settings',
        'modal.provider.proxy.testBtn': 'Proxy self-test',
        'modal.provider.proxy.testRunning': 'Running proxy test...',
        'modal.provider.proxy.testOk': 'Proxy test OK',
        'modal.provider.proxy.testFailed': 'Proxy test failed',
        'modal.provider.proxy.enabled': 'Proxy',
        'modal.provider.proxy.disabled': 'Proxy disabled',
        'modal.provider.proxy.none': 'No proxy',
        'modal.provider.bitbrowser.badge.none': 'No browser profile bound',
        'modal.provider.bitbrowser.badge.on': 'Isolated Browser',
        'modal.provider.bitbrowser.openBtn': 'Open isolated browser',
        'modal.provider.bitbrowser.oauthBtn': 'Isolated OAuth',
        'modal.provider.bitbrowser.opening': 'Opening isolated browser...',
        'modal.provider.bitbrowser.opened': 'Isolated browser opened (Profile: {id})',
        'modal.provider.bitbrowser.openFailed': 'Failed to open isolated browser',
        'modal.provider.bitbrowser.unsupported': 'Isolated browser is not supported for this provider',
        'modal.provider.bitbrowser.oauthFailed': 'Failed to start isolated OAuth',
        'modal.provider.kiro.inspectBtn': 'Account details',
        'modal.provider.kiro.inspectTitle': 'Kiro Account Details',
        'modal.provider.kiro.inspectLoading': 'Fetching account details...',
        'modal.provider.kiro.inspectFailed': 'Failed to fetch account details',
        'modal.provider.kiroWizard.btn': 'Enterprise Wizard',
        'modal.provider.kiroWizard.title': 'Add Enterprise Kiro Account',
        'modal.provider.kiroWizard.accountId': 'Account ID',
        'modal.provider.kiroWizard.accountIdHint': 'Auto-generated; you can rename it anytime for ops/logging',
        'modal.provider.kiroWizard.machineId': 'Machine ID',
        'modal.provider.kiroWizard.machineIdHint': 'Optional. Leave blank to auto-generate. Allowed: 8-128 chars, [A-Za-z0-9._:-].',
        'modal.provider.kiroWizard.proxyTitle': 'Proxy (recommended: one per account)',
        'modal.provider.kiroWizard.proxyEnabled': 'Enable proxy',
        'modal.provider.kiroWizard.proxyUrl': 'Proxy URL',
        'modal.provider.kiroWizard.proxyUrlHint': 'Supports socks5://, http://, https:// (example: socks5://user:pass@host:port)',
        'modal.provider.kiroWizard.bitbrowserTitle': 'Isolated Browser (BitBrowser)',
        'modal.provider.kiroWizard.useBitbrowser': 'Use isolated browser for login',
        'modal.provider.kiroWizard.bitbrowserEnabled': 'Enable BitBrowser',
        'modal.provider.kiroWizard.bitbrowserApiUrl': 'BitBrowser API URL',
        'modal.provider.kiroWizard.bitbrowserCoreVersion': 'Core version',
        'modal.provider.kiroWizard.bitbrowserHint': 'The BitBrowser window opens on the machine running BitBrowser core. For remote, use RDP/SSH GUI.',
        'modal.provider.kiroWizard.wslHint': 'If AIClient runs in WSL and BitBrowser runs on Windows host, API URL is often http://172.17.16.1:54345',
        'modal.provider.kiroWizard.idcTitle': 'IAM Identity Center (SSO)',
        'modal.provider.kiroWizard.startUrl': 'Start URL',
        'modal.provider.kiroWizard.region': 'AWS Region',
        'modal.provider.kiroWizard.createAndLogin': 'Create & Login',
        'modal.provider.kiroWizard.creating': 'Creating account and starting enterprise login...',
        'modal.provider.risk.state.healthy': 'Healthy',
        'modal.provider.risk.state.needs_refresh': 'Needs Refresh',
        'modal.provider.risk.state.cooldown': 'Cooldown',
        'modal.provider.risk.state.quarantined': 'Quarantined',
        'modal.provider.risk.state.suspended': 'Suspended',
        'modal.provider.risk.state.banned': 'Banned',
        'modal.provider.risk.state.disabled': 'Disabled',
        'modal.provider.risk.state.unknown': 'Unknown',
        'modal.provider.risk.modal.titleInfo': 'Credential Release Info',
        'modal.provider.risk.modal.titleRelease': 'Manual Credential Release',
        'modal.provider.risk.form.targetState': 'Target State',
        'modal.provider.risk.form.operator': 'Operator',
        'modal.provider.risk.form.reason': 'Release Reason',
        'modal.provider.risk.form.reasonPlaceholder': 'Provide release reason (minimum 8 characters)',
        'modal.provider.risk.form.confirmCredentialId': 'Confirm Credential ID',
        'modal.provider.risk.form.releaseTicketId': 'Release Ticket',
        'modal.provider.risk.form.force': 'Force Release',
        'modal.provider.risk.form.forceRequiredHint': 'The current state requires force=true for release',
        'modal.provider.risk.form.ack': 'I verified the credential ID and reason, and approve this action',
        'modal.provider.risk.form.submit': 'Release',
        'modal.provider.risk.form.submitting': 'Submitting manual release...',
        'modal.provider.risk.validation.cannotRelease': 'The current state is not eligible for manual release',
        'modal.provider.risk.validation.targetRequired': 'Please select a valid target state',
        'modal.provider.risk.validation.reasonTooShort': 'Release reason must be at least 8 characters',
        'modal.provider.risk.validation.confirmMismatch': 'Credential ID does not match',
        'modal.provider.risk.validation.ackRequired': 'Please confirm the acknowledgement checkbox',
        'modal.provider.risk.ops.title': 'Risk Control Actions',
        'modal.provider.risk.ops.policyMode': 'Policy Mode',
        'modal.provider.risk.ops.policyEnabled': 'Policy Enabled',
        'modal.provider.risk.ops.policyEnabledSet': 'Set Policy Enabled',
        'modal.provider.risk.ops.policyModeSet': 'Set Policy Mode',
        'modal.provider.risk.ops.collisionWindowMs': 'Collision Window (ms)',
        'modal.provider.risk.ops.drainMode': 'Drain Mode',
        'modal.provider.risk.ops.drainOn': 'Drain On',
        'modal.provider.risk.ops.drainOff': 'Drain Off',
        'modal.provider.risk.ops.cooldownMinutes': 'Cooldown Minutes',
        'modal.provider.risk.ops.reason': 'Action Reason',
        'modal.provider.risk.ops.reasonPlaceholder': 'Provide operator reason for audit trail',
        'modal.provider.risk.ops.updatePolicy': 'Update Policy',
        'modal.provider.risk.ops.policyUpdated': 'Policy updated successfully',
        'modal.provider.risk.ops.applyDrain': 'Apply Drain',
        'modal.provider.risk.ops.applyCooldown': 'Apply Cooldown',
        'modal.provider.risk.ops.clearCooldown': 'Clear Cooldown',
        'modal.provider.risk.ops.forceRefresh': 'Force Refresh',
        'modal.provider.risk.ops.refreshPreview': 'Refresh Selection Preview',
        'modal.provider.risk.ops.executing': 'Executing action...',
        'modal.provider.risk.ops.actionSuccess': 'Action succeeded: {action}',
        'modal.provider.risk.ops.actionFailed': 'Action failed',
        'modal.provider.risk.ops.fetchFailed': 'Failed to load risk operator context',
        'modal.provider.risk.ops.invalidCooldown': 'Please enter a valid cooldown value in minutes',
        'modal.provider.risk.ops.invalidCollisionWindow': 'Please enter a valid collision window in milliseconds',
        'modal.provider.risk.policy.fetchFailed': 'Failed to fetch risk policy config',
        'modal.provider.risk.preview.fetchFailed': 'Failed to fetch selection preview',
        'modal.provider.risk.preview.loading': 'Loading selection preview...',
        'modal.provider.risk.preview.empty': 'No selection preview data',
        'modal.provider.risk.preview.noneSelected': 'No candidate selected',
        'modal.provider.risk.preview.selected': 'Selected',
        'modal.provider.risk.preview.total': 'Total',
        'modal.provider.risk.preview.candidates': 'Candidates',
        'modal.provider.risk.preview.blocked': 'Blocked',
        'modal.provider.risk.preview.topCandidates': 'Top Candidates',
        'modal.provider.risk.preview.priority': 'Priority',
        'modal.provider.risk.preview.score': 'Score',
        'modal.provider.risk.preview.nextAvailableAt': 'Next Available At',
        'modal.provider.risk.preview.excluded': 'Excluded',
        'modal.provider.risk.preview.excluded.disabled': 'Disabled',
        'modal.provider.risk.preview.excluded.unhealthy': 'Unhealthy',
        'modal.provider.risk.preview.excluded.needsRefresh': 'Needs Refresh',
        'modal.provider.risk.preview.excluded.draining': 'Draining',
        'modal.provider.risk.preview.excluded.coolingDown': 'Cooling Down',
        'modal.provider.risk.preview.excluded.blockedByRiskPolicy': 'Blocked by Risk Policy',
        'modal.provider.risk.preview.excluded.modelNotSupported': 'Model Not Supported',
        'modal.provider.field.projectId': 'Project ID',
        'modal.provider.field.oauthPath': 'OAuth Credentials File Path',
        'modal.provider.field.baseUrl': 'Base URL',
        'modal.provider.field.refreshUrl': 'Refresh URL',
        'modal.provider.field.refreshIdcUrl': 'Refresh IDC URL',
        'modal.provider.field.machineId': 'Machine ID',
        'modal.provider.field.machineId.placeholder': 'e.g. a1b2c3d4e5f6...',
        'modal.provider.field.proxyUrl': 'Proxy URL (Node)',
        'modal.provider.field.proxyUrl.placeholder': 'e.g. http://127.0.0.1:7890 or socks5://127.0.0.1:1080',
        'modal.provider.field.bitbrowserProfileId': 'BitBrowser Profile ID',
        'modal.provider.field.bitbrowserProfileId.placeholder': 'e.g. 93672cf112a044f08b653cab691216f0',
        'modal.provider.field.accountId': 'Account ID',
        'modal.provider.field.accountId.placeholder': 'e.g. kiro-account-01',
        'modal.provider.field.authMethod': 'Auth Method',
        'modal.provider.field.authMethod.placeholder': 'social or builder-id',
        'modal.provider.field.profileArn': 'Profile ARN',
        'modal.provider.field.profileArn.placeholder': 'e.g. arn:aws:iam::123456789012:user/demo',
        'modal.provider.field.refreshToken': 'Refresh Token',
        'modal.provider.field.refreshToken.placeholder': 'Optional: override refreshToken from credential file',
        'modal.provider.field.clientId': 'Client ID',
        'modal.provider.field.clientId.placeholder': 'Optional: clientId for IDC refresh',
        'modal.provider.field.clientSecret': 'Client Secret',
        'modal.provider.field.clientSecret.placeholder': 'Optional: clientSecret for IDC refresh',
        'modal.provider.field.oauthBaseUrl': 'OAuth Base URL',
        'modal.provider.field.dailyBaseUrl': 'Daily Base URL',
        'modal.provider.field.autopushBaseUrl': 'Autopush Base URL',
